...
- **Favor clarity over brevity when asking a question** — a teammate reading on their phone has none of your context, so
  spell out what you're asking and why instead of trimming it down to something terse. A concrete example or two of the
  options often makes it click faster than more prose.
